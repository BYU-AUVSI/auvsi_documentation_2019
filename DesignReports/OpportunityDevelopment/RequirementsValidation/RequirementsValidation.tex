...
\entry{DJ-005, 0.2, 10-09-18, Final edits for Design Review, Tyler Critchfield, Ryan Anderson}
\entry{DJ-005, 1.0, 10-17-2018, Fixed points inconsistency, Andrew Torgesen, Jacob Willis}
\end{artifacttable}
...
The competition also allots 10\% of points to driving accuracy of the UGV. This part of the competition is novel and challenging, and while we plan to pursue those points, we are deciding to not include it as a key success measure. This is planning for the case that as the competition approaches, we may decide it is in our best interests to focus our time and effort on other areas. 
	\begin{itemize}
