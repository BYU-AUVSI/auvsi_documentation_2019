...
\entry{RM-001, 2.1, 04-05-2019, Corrected Typo in Measured Values, Kameron Eves, [Checker]}
\end{artifacttable}
\end{AUVSITitlePage}
...
%\begin{sidewaysfigure}
	...
	\captionof{figure}{Top-level requirements matrix for the unmanned aerial system. Performance measures that are marked in grey are our key success measures. Importance measurements directly show the percentage of mission demonstration points available for that requirement and measure. Note that cumulatively, our key success measures account for 46\% of the possible points.}
	\label{fig:reqMat}
	\end{center}
%\end{sidewaysfigure}
