...
\begin{artifacttable}
\entry{CS-001, 1.0, 10-31-2018, Concept development initial stage, Ryan Anderson, Andrew Torgesen}
...
\begin{sidewaystable}
\begin{center}
	\captionof{table}{Concept Selection Matrix for the airframe.}\label{tab:proj_app}
	\begin{tabular}{|p{2.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{2cm}|p{2cm}|p{2cm}|p{1.5cm}|p{1.5cm}|}
		\hline	
		\rowcolor[HTML]{C0C0C0}	
		{\color[HTML]{000000} \textbf{Metric}} & {\color[HTML]{000000} \textbf{Weight}} & {\color[HTML]{000000} \textbf{My Twin Dream}} & {\color[HTML]{000000} \textbf{Nimbus Pro}} & {\color[HTML]{000000} \textbf{Titan}} & {\color[HTML]{000000} \textbf{Modified My Twin Dream}} & {\color[HTML]{000000} \textbf{Modified Nimbus Pro}} & {\color[HTML]{000000} \textbf{Custom Traditional Fixed Wing}} & {\color[HTML]{000000} \textbf{Custom Flying Wing}} & {\color[HTML]{000000} \textbf{Hexa copter}} \\ \hline
		
		\centering{Wing Area} & \centering{2} & \centering{3} & \centering{4} & \centering{4} & \centering{5} & \centering{5} & \centering{5} & \centering{5} & \centering{5} & \hline
		
		\centering{Weight} & \centering{2} & \centering{3} & \centering{2} & \centering{2} & \centering{3} & \centering{2} & \centering{4} & \centering{5} & \centering{4} & \hline
		
		\centering{$\frac{Wing Area}{Weight}$} & \centering{4} & \centering{3} & \centering{4} & \centering{4} & \centering{5} & \centering{5} & \centering{5} & \centering{5} & \centering{5} & \hline 
		
		\centering{Volume Capacity} & \centering{4} & \centering{3} & \centering{4} & \centering{5} & \centering{3} & \centering{4} & \centering{4} & \centering{1} & \centering{5} & \hline
		
		\centering{Stability Control} & \centering{2} & \centering{3} & \centering{3} & \centering{2} & \centering{3} & \centering{3} & \centering{4} & \centering{2} & \centering{5} & \hline
		
		\centering{Build Time} & \centering{5} & \centering{3} & \centering{3} & \centering{3} & \centering{2} & \centering{2} & \centering{1} & \centering{2} & \centering{2} & \hline
		
		\centering{Monetary Cost} & \centering{1} & \centering{3} & \centering{3} & \centering{3} & \centering{2} & \centering{2} & \centering{4} & \centering{4} & \centering{1} & \hline
		
		\centering{Range} & \centering{5} & \centering{3} & \centering{3} & \centering{3} & \centering{3} & \centering{3} & \centering{3} & \centering{3} & \centering{1} & \hline

		\centering{Controls Implementation} & \centering{5} & \centering{3} & \centering{3} & \centering{2} & \centering{3} & \centering{3} & \centering{2} & \centering{1} & \centering{1} & \hline

		\centering{\textbf{Totals}} & \centering{\textbf{30}} & \centering{\textbf{90}} & \centering{\textbf{98}} & \centering{\textbf{95}} & \centering{\textbf{96}} & \centering{\textbf{98}} & \centering{\textbf{96}} & \centering{\textbf{82}} & \centering{\textbf{85}} & \hline
