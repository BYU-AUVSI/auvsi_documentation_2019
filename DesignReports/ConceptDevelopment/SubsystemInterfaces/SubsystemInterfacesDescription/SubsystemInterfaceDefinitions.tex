...
\entry{SS-001, 1.1, 11-05-2018, added introduction and fixed typos, Andrew Torgesen, ...}
\end{artifacttable}
\end{AUVSITitlePage}
...
\begin{center}
	...
	\begin{tabular}{ P{5cm}P{10cm} }
		...
		\item Intertial Sense: reads in GPS and inertial sensor data \end{itemize}  \\[-0.5cm]
