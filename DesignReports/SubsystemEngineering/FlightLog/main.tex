...
\begin{artifacttable}
	...
	\entry{AF-004, 0.3, 2-5-2019, Added Takeoff/Landing Tracker, Kameron Eves, Brandon McBride}
\end{artifacttable}
...
\begin{longtable}{| c | p{2 cm} | c | c | p{7.25 cm} |}
	...
	\hline
	3-5-19				&  Utah County Airfield	&	14 & 	2/2			& Two flights to collect imaging data. Successful. Nothing to report.\\
	\hline
	3-26-19				& Utah County Airfield 	&		\makecell{28 \\ \textbf{9}} & 	\makecell{3/2 \\ \textbf{0/1}}			& Three flights. Dropped payload successfully twice. Flew 3 waypoints and landed autonomously.\\
	\hline
	3-31-19				& Utah County Airfield 	&		4 & 1/0			& Safety pilot accidentally disarmed the plane while trying to transition to the autopilot. This caused loss of power, and, after this was realized, it was too late to save the aircraft from crashing. Aircraft landed in a bush and was mostly saved. \\
	\hline
...
%\end{table}
\end{center}
\textbf{Total Flight Time:} 3 Hour 13 Minutes 

\textbf{Manual Flight Time:} 2 Hour 47 Minutes*

\textbf{Autonomous Flight Time:} 26 Minutes

\textbf{Percent of Autonomous Flight:} 15.6\%
\hrule
...
\hrule
\textbf{Percent of Flights Ending in Crash:} 27.6\%
\hrule
