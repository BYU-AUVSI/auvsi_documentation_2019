...
%\end{table}
\end{center}
\textbf{Total Flight Time:} 2 Hour 17 Minutes 

\textbf{Manual Flight Time:} 2 Hour 2 Minutes*

\textbf{Autonomous Flight Time:} 15 Minutes

\textbf{Percent of Autonomous Flight:} 10.9\%
\hrule
\textbf{Manual Takeoffs:} 22*

\textbf{Manual Landings:} 16*

\textbf{Autonomous Takeoffs:} 0

\textbf{Autonomous Landings:} 0
\hrule
\textbf{Percent of Flights Ending in Crash:} 27.3\%

\textbf{Flights Sense Last Crash:} 16
\hrule
