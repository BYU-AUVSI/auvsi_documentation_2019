...
%\end{table}
\end{center}
\textbf{Total Flight Time:} 2 Hour 27 Minutes

\textbf{Manual Flight Time:} 2 Hour 12 Minutes*

\textbf{Autonomous Flight Time:} 15 Minutes

\textbf{Percent of Autonomous Flight:} 10.2\%
\hrule
\textbf{Manual Takeoffs:} 23*

\textbf{Manual Landings:} 17*

\textbf{Autonomous Takeoffs:} 0

\textbf{Autonomous Landings:} 0
\hrule
\textbf{Percent of Flights Ending in Crash:} 26.1\%

\textbf{Flights Sense Last Crash:} 17
\hrule
